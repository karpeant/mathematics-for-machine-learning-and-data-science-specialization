...
def test_forward_propagation(target_forward_propagation):
    ...
    for test_case in test_cases:
        ...
        for test_case_i_j in test_case["expected"]["Z1_array"]["Z1"]:
            ...
            try:
                assert np.isclose(result_cache["Z1"][i, j], test_case_i_j["Z1_i_j"], atol=1e-10)
                successful_cases += 1
        ...
        for test_case_i_j in test_case["expected"]["A1_array"]["A1"]:
            ...
            try:
                assert np.isclose(result_cache["A1"][i, j], test_case_i_j["A1_i_j"], atol=1e-10)
                successful_cases += 1
        ...
        for test_case_i in test_case["expected"]["Z2_array"]["Z2"]:
            ...
            try:
                assert np.isclose(result_cache["Z2"][0, i], test_case_i["Z2_i"], atol=1e-10)
                successful_cases += 1
        ...
        for test_case_i in test_case["expected"]["A2_array"]["A2"]:
            ...
            try:
                assert np.isclose(result_A2[0, i], test_case_i["A2_i"], atol=1e-10)
                successful_cases += 1
